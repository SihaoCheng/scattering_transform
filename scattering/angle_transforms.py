...
#                 ), dim=-2)
                ...
                C11_fp = torch.cat((
                    torch.cat((
                        ...
                        torch.cat((C11_f[...,0:1,L//2+1:,L:L+1], C11_f[...,0:1,L//2+1:,1:L]), dim=-1),
                    ), dim=-2),
                    C11_f[...,1:L//2,:,0:L],
                    torch.cat((
                        ...
                        torch.cat((C11_f[...,L//2:L//2+1,L//2+1:,L:L+1], C11_f[...,L//2:L//2+1,L//2+1:,1:L]), dim=-1),
                    ), dim=-2),
                    torch.cat((C11_f[...,L//2+1:,:,L:L+1], C11_f[...,L//2+1:,:,1:L]), dim=-1),
                ), dim=-3)
